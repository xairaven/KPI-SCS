...
mod tests {
    ...
    fn test_tokenize_08() {
        ...
        let tokens_expected = vec![
            ...
            token!(TokenType::Unknown, '['.to_string(), 42),
            ...
            token!(TokenType::Unknown, ']'.to_string(), 49),
        ];
    ...
    fn test_tokenize_13() {
        ...
        let tokens_expected = vec![
            ...
            token!(TokenType::Unknown, ']'.to_string(), 59),
        ];
    ...
    fn test_tokenize_17() {
        ...
        let tokens_expected = vec![
            ...
            token!(TokenType::Unknown, '['.to_string(), 43),
